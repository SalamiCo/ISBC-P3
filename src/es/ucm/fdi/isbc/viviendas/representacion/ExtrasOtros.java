...
public class ExtrasOtros implements CaseComponent {
    ...
    public String toString () {
        ...
        return sincon("patio", patio, true) //
                + sincon("balcon", balcon, true) //
                + sincon("zonaDeportiva", zonaDeportiva, true) + "\n" //
                + sincon("zonaComunitaria", zonaComunitaria, true) //
                + sincon("terraza", terraza, true) //
                + sincon("piscinaComunitaria", piscinaComunitaria, true) + "\n"//
                + sincon("jardinPrivado", jardinPrivado, true) //
                + sincon("zonaInfantil", zonaInfantil, true) //
                + sincon("piscina", piscina, false); //
    }
