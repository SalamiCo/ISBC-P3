...
public final class MainFrame extends JFrame {
	...
	private ViviendaPanel results[] = { new ViviendaPanel(),
			new ViviendaPanel(), new ViviendaPanel(), new ViviendaPanel(),
			new ViviendaPanel() };
	...
	private void setupListeners() {
		buscarBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent arg0) {
				try {
					DescripcionVivienda initialDescription = new DescripcionVivienda(
							0);
					initialDescription.setTipo(TipoVivienda
							.valueOf(comboVivienda.getSelectedItem().toString()));
					initialDescription.setLocalizacion(textLocalidad.getText());
					initialDescription
							.setHabitaciones(((Number) spinHabitaciones
									.getValue()).intValue());
					initialDescription.setPrecio(((Number) spinPrecio
							.getValue()).intValue());
	...
	private void setupPanel1() {
		...
		spinPrecio.setModel(new SpinnerNumberModel(350000, 50000, 5000000,
				100000));
	...
	private void showCases(Collection<CBRCase> cases) {
		...
		while (it.hasNext()) {
			...
			DescripcionVivienda desc = (DescripcionVivienda) casoCBR
					.getDescription();
